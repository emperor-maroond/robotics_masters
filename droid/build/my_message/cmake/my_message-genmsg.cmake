...
set(MSG_I_FLAGS "-Imy_message:/home/devlon/robotics_masters/droid/src/my_message/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/devlon/robotics_masters/droid/src/my_message/msg/my_message.msg" NAME_WE)
add_custom_target(_my_message_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "my_message" "/home/devlon/robotics_masters/droid/src/my_message/msg/my_message.msg" ""
)
...
_generate_msg_cpp(my_message
  "/home/devlon/robotics_masters/droid/src/my_message/msg/my_message.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/my_message)
  install(CODE "execute_process(COMMAND \"/home/devlon/anaconda3/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/my_message\")")
  # install generated code
  install(
