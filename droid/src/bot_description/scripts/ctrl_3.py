...
def callback(data):
    global i, ref_height, startup, apex_reached,transition
    ...
    if height<=300/1000 and apex_reached: # Check the correct height
        apex_reached = False     
        i+=1
    elif height>=400/1000 and not apex_reached:
        apex_reached = True
        i+=1
